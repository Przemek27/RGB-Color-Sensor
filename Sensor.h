...
static void pause(void);		// this delay is very important, it may cause w-r operation failure.

uint8_t APDS9960_read_reg(uint8_t addr);
void APDS9960_write_reg(uint8_t addr, uint8_t data);
...
void setMode(uint8_t mode, uint8_t enable);	//ustaw tryb
